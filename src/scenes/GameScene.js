...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('start','src/GameScene/game-start-6104.mp3');
    ...
    create() {
        ...
        monster1 = this.physics.add.sprite(5700, 700, 'mon1').setScale(0.8);
        monster2 = this.physics.add.sprite(9800, 700, 'mon2').setScale(4);
